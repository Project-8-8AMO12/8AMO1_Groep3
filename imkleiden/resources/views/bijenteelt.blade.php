...
{{--Jumbotron--}}
<div class="jumbotron">
    <center><h1 class="display-4">Over onze bijenteelt!</h1>
        <p class="lead">Bijenteelt wordt door ons beheert in Leiden</p>
        <hr class="my-4">
        <p>Wij zijn experts op het gebied van bijenteelt en zwermen.</p>
        <p class="lead">
            <a class="btn btn-success btn-lg" href="#" role="button">Meer over onze bijenteelt!</a>
        </p></center>
</div>
